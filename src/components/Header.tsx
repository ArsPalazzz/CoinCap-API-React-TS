...
export const Header = () => {
    ...
    const initialSum = portfolioData.reduce((sum: number, item: CoinInPortfolioObject) => sum + item.priceUsd, 0);
    ...
    return (
        <header>
            {   <nav className={classes.navigation}>
                ...
                <p>Portfolio cost: {initialSum.toFixed(2)} USD + {lastAddedItem? lastAddedItem.priceUsd.toFixed(2) : 0} ({percent.toFixed(2)}%)</p>
